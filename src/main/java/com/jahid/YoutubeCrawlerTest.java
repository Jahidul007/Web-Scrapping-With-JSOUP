...
*/
        Thread.sleep(5000);
        driver.get("https://www.youtube.com/results?search_query=Android+bangla+tutorial&sp=CAM%253D");
        ...
        try {
            ...
            OBJECT_MAPPER.writerWithDefaultPrettyPrinter().writeValue(new File("commentsAndroid.json"), resultList);
            OBJECT_MAPPER.writerWithDefaultPrettyPrinter().writeValue(new File("detailsAndroid.json"), detailsList);
